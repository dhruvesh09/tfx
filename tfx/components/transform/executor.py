...
class Executor(base_beam_executor.BaseBeamExecutor):
    ...
    Args:
      ...
      exec_properties: A dict of execution properties, including:
        ...
        - 'stats_options_updater_fn': The module path to a python function that
          implements 'stats_options_updater_fn'. This cannot be specified if
          'module_file' is.
  ...
  def _GetStatsOptionsUpdaterFn(
    ...
    has_stats_options_updater_fn = bool(
        value_utils.GetSoleValue(inputs,
                                 labels.STATS_OPTIONS_UPDATER_FN, strict=False))

    num_fn_defs = (int(has_module_file) + int(has_module_path) +
