...
class PenguinPipelineKubeflowTest(kubeflow_test_utils.BaseKubeflowTest):
  ...
  def testPenguinPipelineConstructionAndDefinitionFileExists(
    ...
    kubeflow_pipeline = penguin_pipeline_kubeflow.create_pipeline(
        ...
        transform_module=penguin_pipeline_kubeflow._module_file,
        trainer_module=penguin_pipeline_kubeflow._module_file,
        tuner_module=penguin_pipeline_kubeflow._module_file,
        enable_tuning=True,
    ...
    # self.assertEqual(10, len(kubeflow_pipeline.components))
  ...
  def testEndToEndPipelineRun(self):
    ...
    kubeflow_pipeline = penguin_pipeline_kubeflow.create_pipeline(
        ...
        transform_module=self._transform_module,
        trainer_module=self._trainer_module,
        tuner_module=None,
        enable_tuning=False,
        ai_platform_training_args=penguin_pipeline_kubeflow
        ._ai_platform_training_args,
    ...
    # self.assertTrue(fileio.exists(penguin_pipeline_kubeflow._serving_model_dir))
