...
def create_pipeline(
  ...
  Args:
    ...
    trainer_module: uri of the module file used in Trainer.
    transform_module: uri of the module file used in Transform.
    tuner_module: uri of the module file used in Tuner.
  ...
  # TODO(b/190231146) update the data_root after penguin data source checked in.
...
def main():
  ...
  tfx.orchestration.experimental.KubeflowDagRunner(config=runner_config).run(
      create_pipeline(
          ...
          trainer_module=_module_file,
          transform_module=_module_file,
          tuner_module=_module_file,
          enable_tuning=True,
...
# python penguin_pipeline_kubeflow.py --use_aip_component=True or False
